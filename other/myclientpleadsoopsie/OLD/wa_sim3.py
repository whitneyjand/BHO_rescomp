...
if __name__ == '__main__':
    ...
    def function_to_be_optimized(g, s, a):
        ...
        def run_once(n_):
            ...
            ### CHANGED - dt: from 0.01 to 0.001, vpttol: from 0.6 to 5, and duration: from 1000 to 40
            
            return vpt
        
        vpts = bview.map_sync(run_once, range(100))
    ...
    sys.stdout = open(f'wa_simlog_2_{rho}_{pthin}.txt', 'a')
    print(optimizer.maximize(init_points=10, n_iter=20))
